...
|-----|---------|-------|----------|
| 1   | [Palindrome Number](https://leetcode.com/problems/palindrome-number/) | BASICS OF JAVA | [Link](https://leetcode.com/problems/palindrome-number/?envType=problem-list-v2&envId=nxoay8y6) |
| 2   | ...     | ...   | ...      |
